...
//
//fun main() {
//    var valor = arrayOf(18, 32, 25, 90) // Cria uma matriz (array) de inteiros chamada 'valor' com quatro elementos
//    println(valor[0]) // Imprime o primeiro elemento da matriz 'valor', que é 18
//}
